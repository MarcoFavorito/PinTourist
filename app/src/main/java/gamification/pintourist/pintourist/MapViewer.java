...
public class MapViewer {
    ...
    public void setUpMap() {
        mMap.addMarker(new MarkerOptions().position(new LatLng(MapsActivity.getmAvatar().getAvatarLocation().getLatitude(), MapsActivity.getmAvatar().getAvatarLocation().getLongitude())).title("Marker"));
        CameraPosition cameraPosition = new CameraPosition.Builder()
                .target(new LatLng(MapsActivity.getmAvatar().getAvatarLocation().getLatitude(), MapsActivity.getmAvatar().getAvatarLocation().getLongitude()))      // Sets the center of the map to mi position
